      ...
      <LayoutContainer>
        <div className="header-space p-4">
          ...
          <SectionWithHeadline headline="Content Liability">
            <p>
              The contents of our pages were created with great care. However,
              we cannot guarantee the accuracy, completeness, or timeliness of
              the content. As a service provider, we are responsible for our own
              ...
              unaffected. Any liability in this regard, however, is only
              possible from the point in time at which we become aware of a
              specific infringement. Upon becoming aware of such legal
          ...
          <SectionWithHeadline headline="External Links">
            <p>
              ...
              on whose content we have no influence. Therefore, we cannot assume
          ...
          <SectionWithHeadline headline="Copyright">
            <p>
              ...
              infringement, we request that you notify us accordingly. Upon
              notification of violations, we will remove such content
              immediately.
            </p>
          </SectionWithHeadline>
          ...
          <SectionWithHeadline headline="Privacy">
            <p>
              ...
              always done on a voluntary basis, if possible. This data will not
              be passed on to third parties without your express consent. Please
              note that data transmission over the internet (e.g., communication
              by email) can have security vulnerabilities. A complete protection
              of data against access by third parties is not possible. We
              expressly object to the use of contact data published within the
              scope of the imprint obligation by third parties for the
              transmission of unsolicited advertising and information materials.
              The operators of the pages expressly reserve the right to take
              legal action in the event of unsolicited sending of advertising
          ...
          <SectionWithHeadline headline="Legal Jurisdiction">
            <p>
              ...
              connection with this website will be subject to the jurisdiction
              of the courts in Bremen, Germany.
            </p>
          </SectionWithHeadline>
